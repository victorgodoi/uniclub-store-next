        ...
        <div className="bg-banner02 bg-no-repeat bg-center bg-cover h-[500px] w-full flex items-center justify-center">
            <div className="h-[500px] w-full flex items-center justify-center">
                <div className="w-[990px] flex gap-[185px]">
                    <div>
                        <p className={classNames("text-white text-[52px] leading-tight tracking-[-2.6px]", playfair.className)}>Get 20% <span className="font-bold italic">OFF</span> on your first purchase</p>
                        <p className="mt-5 text-grey3 leading-normal">Sign Up for our newsletter and never miss any offers</p>
                    </div>
                    <div>
                        <input className='rounded-lg border-input w-[350px] h-[57px] px-[10px] text-base outline-none' placeholder="Your email address"></input>
